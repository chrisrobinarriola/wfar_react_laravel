                ...
                this.state.wfars.map((item) => {
                    return (
                        <tr key={item.id}>
                            ...
                            <td>{item.subject}</td>
                            <td>
                                <Link to={`/edit-wfar/${item.id}/${this.props.params.id}`} className="btn btn-dark btn-sm">View</Link>
                            </td>
                        </tr>
                    );
                });
                    ...
                    <div className="col-md-12">
                        <div className="card">
                            <div className="card-header">
                                <h4>Edit Week
                                    <Link to={'/edit-semester/' + this.props.params.semester_id} className="btn btn-warning btn-sm float-end"> BACK </Link>
                                </h4>
                            </div>
                            ...
                            <div className="card-header">
                                <h4>WFARs on this week
                                    <Link to={'/add-wfar/' + this.props.params.id} className="btn btn-light btn-sm float-end"> Add WFAR </Link>
                                </h4>
                            </div>
                            <div className="card-body">
