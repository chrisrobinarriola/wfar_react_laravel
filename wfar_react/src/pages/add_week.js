...
class Add_Week extends Component
{
    state = {
        name: '',
                    ...
                    <div className="col-md-12">
                        <div className="card">
                            <div className="card-header">
                                <h4>Add Week
                                    <Link to={'/edit-semester/'+ this.props.params.id} className="btn btn-warning btn-sm float-end"> BACK </Link>
                                </h4>
                            </div>
...
export default withParams(Add_Week);